        ...
        <ContentLayout>
            <section className="container mx-auto px-3 py-4 h-full grid grid-cols-3 grid-rows-2 gap-5">
                 <article className="flex flex-col items-center">
                    ...
                    <BarChart spreadsheetTab={'Events'} dimensions={['event', 'Percentage Signedup and Attended', 'Total Attendance over Expected Attendance', 'Industry Average']} series={[{ type: 'bar' }, { type: 'bar' }, { type: 'line'} ]} />
                </article>
                <article className="flex flex-col items-center">
                    <h2 className="text-xl font-poppins font-semibold text-stackup">Community-led Events</h2>
                    <BarChart spreadsheetTab={'Hard+Stats'} dimensions={['month', 'community-led events held']} series={[{ type: 'line', smooth: true  }]} />
                </article>
                <article className="flex flex-col items-center">
                    <h2 className="text-xl font-poppins font-semibold text-stackup">Server Highlights Stats</h2>
                    <BarChart spreadsheetTab={'Hard+Stats'} dimensions={['month', 'message volume', 'activated users']} series={[{ type: 'bar' }, { type: 'line', smooth: true },]} />
                </article>
